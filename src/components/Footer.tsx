      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-display font-bold text-xl">HealthGuard<span className="text-primary">AI</span></span>
            </div>
            <p className="text-background/70 mb-6 max-w-md">
              AI-powered global health protection platform. Helping communities detect risk early, prevent outbreaks, and access quality healthcare guidance.
            </p>
        ...
        <div className="border-t border-background/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-background/60">
            © 2024 HealthGuardAI. All rights reserved. Not for medical diagnosis.
          </p>
