        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-lg text-muted-foreground mb-8">
              Our platform directly supports global health targets by enabling early detection, improving prevention, and strengthening Africa's health systems in Lassa-endemic and epidemic-prone communities.
            </p>
